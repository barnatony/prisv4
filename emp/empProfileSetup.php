								...
								<div class="tab-pane active" id="changePassword">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-lg-4">
		                                        <?php
																																										$result = mysqli_query ( $conn, "SELECT employee_password FROM employee_personal_details WHERE employee_id='" . $_SESSION ['employee_id'] . "' " );
																																										$row = mysqli_fetch_array ( $result, MYSQLI_ASSOC );
																																										echo '<input class="form-control"  id="oldPass"  name="oldPass" value="' . $row ['employee_password'] . '"  type="hidden">';
																																										?>
		                                     <input class="form-control"
													name="changeFor" value="emp" type="hidden"> <input
                    ...
                    success: function (data) {
                       ...
                       setTimeout(function(){ 
                    	   ...
                    	   location.assign("logout.php"); 
                        	...
                        	$('#profilesetup')[0].reset();
                            BootstrapDialog.alert("Password has Not Been Changed Try With Another New Password");
                            }
                    }
                });
        }
