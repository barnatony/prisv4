...
if (isset ( $_REQUEST ['term'] )) {
	...
	$stmt = mysqli_prepare ( $conn, "SELECT e.employee_id, e.employee_name, b.branch_name, d.department_name, ds.designation_name 
                                        ...
                                        AND (e.employee_name like ? OR e.employee_id like ?) AND e.enabled = 1;" );
	if ($stmt) {
...
mysqli_stmt_bind_result ( $stmt, $employee_id, $employee_name,/* $employee_user_name, $employee_father_name, $employee_gender, $employee_dob, $employee_image, $employee_marital_status, $employee_blood_group, $employee_build_name, $employee_street, $employee_area, $employee_city, $employee_pin_code, $employee_state, $employee_phone, $employee_mobile, $employee_email, $employee_pan_no, $employee_license_no, $employee_passport_no, $employee_bank_name, $employee_acc_no, $employee_bank_ifsc, $employee_bank_branch, $employee_doj, $employee_job_status,*/ $employee_branch, $employee_department, $employee_designation/*, $employee_reporting_person, $employee_emp_pf_no, $employee_emp_esi_no, $employee_slab_id, $employee_salary_amount, $enabled, $updated_on*/);
