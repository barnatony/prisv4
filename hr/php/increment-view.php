...
if (isset ( $_REQUEST ['sSearch'] ) && $_REQUEST ['sSearch'] != "") {
	$sql_where = "WHERE ";
	$col = array('action_id','w.employee_id','CONCAT(w.employee_name," ",w.employee_lastname)','action_effects_from','incremented_amount','DATE_FORMAT(IFNULL(a.processed_on,pro.action_effects_from),"%d/%m/%Y")');
...
// ordering
$sql_order = "ORDER BY processed_on DESC";
