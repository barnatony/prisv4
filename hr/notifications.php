...
<body>
	...
	<section id="container" class="">
     ...
     <?php include_once("sideMenu.php");?>
							...
							<div class="panel-body">
								...
								<div class="task-content">
									...
									<img src="../img/input-spinner.gif" class="ajax_loader"
                                     ...
                                     <?php
																																					$result = $notification->countNotification ( $_SESSION ['login_id'] );
																																					foreach ( $result as $row ) {
																																						?>
                                <input type="hidden" name="mjk" id="mjk"
									value="<?php echo $row['countAdmin']?>">
                                 <?php
																																					}
																																					?>
		...
		<!--main content end-->
		<!--footer start  hp include 'footer.php'?> -->
	...
	<script>
     $(document).ready(function(e){
    		...
    		$.ajax({
    	        ...
    	        cache: false,
    	        data:{act: '<?php echo base64_encode($_SESSION['company_id']."!getAdminNotifications");?>',start_limit:start_limit,end_limit:end_limit},
...
$('#show_more').click(function(e){
	...
	$.ajax({
        ...
        url: "php/notification.handle.php",
        cache: false,
        data:{act: '<?php echo base64_encode($_SESSION['company_id']."!getAdminNotifications");?>',start_limit:add,end_limit:end},
        success: function (data) {
        data = JSON.parse(data);
        $('.ajax_loader').hide();
        if(data[0] == 'success'){
