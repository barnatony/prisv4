										...
										<div class="form-group">
											...
											<div class="col-lg-4">
		                                        <?php
																																										...
																																										echo '<input class="form-control"  id="oldPass" value="' . $row ['password'] . '"  type="hidden">';
																																										?>
		                                     <input class="form-control"
													...
													name="currentPass" id="currentPass" maxlength="8"
													type="text">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input class="form-control" id="confirmPass"
													name="confirmPass" maxlength="8" type="text">
											</div>
										</div>
										<div class="form-group">
