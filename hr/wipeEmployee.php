...
<body>
						...
						<div class="panel-body">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										...
										<input type="text" class="form-control" name="deletedEmpId"
											id="employeeid" value="VM0002" required />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<label class="col-lg-5 checkbox-inline"> <input
											id="employeeCheck" name="wipeEmp" value="emp" type="checkbox">
											Employee Details
											...
											value="tax" name="wipeEmp" type="checkbox"> Income Tax
										</label> <label class="col-lg-4 checkbox-inline"> <input
											value="asset" name="wipeEmp" type="checkbox"> Asset
										</label> <br> <label class="col-lg-5 checkbox-inline"> <input
											value="claims" name="wipeEmp" type="checkbox"> Claims
										</label> <label class="col-lg-4 checkbox-inline"> <input
											value="notifi" name="wipeEmp" type="checkbox"> Notifications
										</label> <br> <label class="col-lg-5 checkbox-inline"> <input
											value="msg" name="wipeEmp" type="checkbox"> Messages
										</label> <label class="col-lg-4 checkbox-inline"> <input
											value="exit" name="wipeEmp" type="checkbox"> NoticePeriod
										</label>
									</div>
								</div>
							</div>
   ...
   $("#employeeCheck").click(function () {
	   if($("#employeeCheck").is(':checked'))
		   $('input:checkbox').not(this).prop('checked', this.checked).attr("disabled", true);
		else
		  $('input:checkbox').not(this).prop('checked', this.checked).attr("disabled", false);
	 });
    </script>
