...
<title>Consultant Creation</title>
<!-- Bootstrap core CSS -->
      ...
      <!--header end-->
		...
		<section id="main-content">
			<section class="wrapper site-min-height">
				<!-- page start-->
				<section class="panel">
					<header class="panel-heading" ><span id="headerSet">Consultant Creation</span>
    	  ...
    	  $("#masterConimage").change(function (e) {
              ...
              function selectAllcompanies(){
            	  ...
            	  $.ajax({
                      ...
                      cache: false,
                      data: { act: '<?php echo base64_encode("!select");?>',loginrole: role,isAllColumsSelect:0 },
		             beforeSend:function(){
                       	$('#loader').loading(true); 
                        },
              ...
              $(document).on('click', "#loginUserTable a.edit", function (e) {
                 ...
                 $('#headerSet').html('Consultant Edit');
              ...
              $(document).on('click', "#loginUserTable a.view", function (e) {
                  ...
                  $('#headerSet').html('<span id="back"  style="color:#EA6229;cursor:pointer">Consultant</span> << View');
                  var masterName = $(this).closest('tr').children(':eq(1)').text();
 	             var masterId = $(this).closest('tr').children(':eq(0)').text();
 	             $('#divShowHide').toggle();
