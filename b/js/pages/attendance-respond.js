...
submitHandler:function(element){
	...
	if(value=="A"){
		  confirmText = 'Do you want to Approve this regularization?';
		  successText = 'Regularization Approved successfully.';
	}else{
		confirmText = 'Do you want to Reject this regularization?';
		successText = 'Regularization Rejected successfully.';
	}
  	...
  	$.ajax({
          ...
          processData: false,
  		  contentType: false,
          url: App.myUrl('attendance/reg_update/'),
          data:data,
