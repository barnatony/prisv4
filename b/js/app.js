...
var App = function() {
    ...
    var uiHelperCkeditor = function(){
        ...
        if (jQuery('#js-ckeditor').length) {
            CKEDITOR.replace('js-ckeditor',{ removePlugins : 'forms,selectall,scayt,find,wsc,flash,about,save,print,templates,newpage,specialchar'});
        }
    };
    ...
    var uiHelperSummernote = function(){
        ...
        $('.js-summernote').attr('required', true).attr('data-summernote', true)
    };
    ...
    var uiHelperDatetimepicker = function(){
        ...
        jQuery('.js-datetimepicker').each(function(){
            ...
            $input.datetimepicker({
                ...
                minDate: $input.data('min-date') ? $input.data('min-date') : false,
    ...
    return {
        ...
        myUrl: function($url,$fullurl){
            if ((typeof($url)==='undefined') && (typeof($fullurl)==='undefined')){
                $url = "";
                $fullurl = false;
            }
        ...
        reFormateByID: function (id) {
        	var str =  id.value;
        	id.value = addCommas(str.replace(/,/g,''));
        },
        reFormateByNumber:function (number) {
...
var minimized_elements = $('div.minimize');
 minimized_elements.each(function(){    
     var t = $(this).text();        
     if(t.length <75) return;
     $(this).html(t.slice(0,75)+'<span>...</span><a href="#" class="more">More</a>'+
     '<span style="display:none;">'+ t.slice(75,t.length)+' <a href="#" class="less">Less</a></span>'
     );
}); 
$('a.more', minimized_elements).click(function(event){
     ...
     $(this).hide().prev().hide();
     $(this).next().show();    
     $(this).toggleClass('h_minimize');
 });
 
 $('a.less', minimized_elements).click(function(event){
     event.preventDefault();
     $(this).parent().hide().prev().show().prev().show();
     $(this).addClass('h_minimize');
 });