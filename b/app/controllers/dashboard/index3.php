...
function _index(){
    ...
    if(!$taxYears)
        $data['taxYears']=null;
            ...
            $data['head'][]='<link rel="stylesheet" href="'.myUrl('css/bootstrap-datetimepicker.css').'">';
            $data['head'][]='<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">';
            $data['head'][]='<link rel="stylesheet" href="'.myUrl('css/prisui.css').'">';
            ...
            $data['foot'][]='<script src="'.myUrl('js/plugins/flot/jquery.flot.min.js').'"></script>';
            $data['foot'][]='<script src="'.myUrl('js/plugins/flot/jquery.flot.pie.min.js').'"></script>';
            ...
            $data['foot'][]='<script src="'.myUrl('js/plugins/bootstrap-datetimepicker/moment.js').'"></script>';
            $data['foot'][]='<script src="'.myUrl('js/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js').'"></script>';
            $data['foot'][]='<script src="http://static.pureexample.com/js/flot/excanvas.min.js"></script>';
            ...
            //$data['foot'][]='<script src="'.myUrl('js/app.js').'"></script>';
