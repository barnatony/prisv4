...
function _speciallr(){
	...
	$data['custom_filters_leave']=$speciallrs->select(' DISTINCT UPPER((leave_type)) leave_type');
	$data['custom_filters_status']=$speciallrs->select(' DISTINCT UPPER((status)) status');
	...
	//$data['foot'][]='<script src="'.myUrl('https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js').'">';
	$data['foot'][]='<script src="'.myUrl('js/core/bootstrap.min.js').'"></script>';
	$data['foot'][]='<script src="'.myUrl('js/plugins/datatables/js/jquery.dataTables.js').'"></script>';
	...
	$data['foot'][]='<script src="'.myUrl('js/plugins/datatables/js/jQuery.dataTables.min.js').'"></script>';
	...
	$data['foot'][]='<script src="'.myUrl('js/plugins/bootstrap-datetimepicker/moment.min.js').'"></script>';
	$data['body'][]=View::do_fetch(VIEW_PATH.'leaveRequests/spciallr.php',$data);
