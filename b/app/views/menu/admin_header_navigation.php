	    ...
	    <li>
	       <div class="btn-group">
                            <button class="btn btn-default btn-image dropdown-toggle img-push-t" data-toggle="dropdown" type="button" aria-expanded="true">
                                <img src="<?php echo myUrl($user->get("image"))?>" alt="<?php echo $_SESSION['display_name'];?>">
                                <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a tabindex="-1" href="<?php echo str_replace('/b/',"/hr/profileSetup.php" , myUrl('',true));?>">
                                        <i class="si si-user pull-right"></i>
                                        <span class="badge badge-success pull-right">1</span>Company Settings
                                    </a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo str_replace('/b/',"/hr/masterSetup.php" , myUrl('',true));?>">
                                        <i class="si si-settings pull-right"></i>Profile Settings
                                    </a>
                                </li>
                                <li>
