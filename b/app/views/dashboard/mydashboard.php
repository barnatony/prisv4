...
<div class="col-lg-12 push-15-t">
 <div class="row">
 	<div class="col-lg-6 col-sm-6 remove-padding-l">  
  		 <div class="row">
    		<div class="col-lg-12 col-md-12 col-xs-12">
    <!-- myself starts here -->
    <div class="col-lg-6 col-sm-6 col-xs-12 remove-padding-r">
    <div class="block block-themed" id="pay-template" style="height:308px !important">
                <div class="block-header bg-modern">
                    <ul class="block-options">
						...
						<li>
							<button class="mypay" data-value="mypay" type="button"><i class="si si-refresh"></i></button>
						</li>
					</ul>
...
<div class="row">
	<div class="col-lg-12 col-sm-12 col-xs-12  remove-padding-l float-l-10">
...
<div class="content bg-default" style="padding-bottom:3px">                   
   <div class="push-15 clearfix">
	<div class="row">
       <div class=" col-lg-6" style="padding-top: 17px;">
			<div class="block block-rounded animated fadeIn" style="padding: 13px;" id="emp-template" href="../img/avatars/avatar4.jpg">
            ...
            <div class="col-lg-12">
 			<div class="row">
				...
				{/select}
	                    ...
	                    <div class="col-lg-9">
	                        <div class="h3 font-w600 push-5">{employee_name} - {employee_id}</div>
				...
				<div class="col-lg-12 text-right" style="margin-top: -54px;">
...
{/myself}
							...
							<div class="col-lg-3" style="padding-top: 17px;">
	                             <div class="block block-rounded animated fadeIn">
	                             	<div id="payout-widget" class="carousel slide auto ">
								...
								<!-- 		<div class="item  text-center active">
                                       ...
                                       <div class="block block-rounded animated fadeIn" style="padding: 8px;">
	                             	<i class="si si-clock text-muted  push-10-l push-5-t  h2"></i> <a class="text-muted  animated zoomIn h3" id="work_hrs">EXPIRED</a>
                        			<h2 class="h5 push-10-t push-10-l text-muted  animated zoomIn" id="date">Wed 04 th April</h2>
                        			<p class="h5 push-5-t push-10-l text-muted  animated zoomIn" id="start-hrs">Today Starts at 10.37</p>
                        			<div class="push-5">
...
<div class="col-lg-6 col-sm-6 remove-padding-r ">
<div class="col-xs-12  float-r-10">
...
<div class="col-lg-6 col-sm-6 remove-padding-l ">
<div class="col-sm-12 col-xs-12  remove-padding-l float-l-10">
...
<div class="row">
	...
	<div class="col-lg-6 col-sm-6 col-xs-6 remove-padding-l">
			<div class="block block-themed float-l-10 pull-t">
					<div class="block-header bg-info">
						 <span class="block-title">Tax Deductable</span>
							 ...
							 <div id="tax-donut" style=" width: 600px;height: 300px;text-align: left;"></div>
...
<section>
<div class="content " style="margin-top:-13px;display:none;">
...
{/select}
				...
				{@select key=employee_gender}
					{@eq value="Female"}
	                    <img class="img-avatar" src="<?php echo myUrl('img/avatars/avatar4.jpg')?>" alt="">
					{:else}
						<img class="img-avatar" src="<?php echo myUrl('img/avatars/avatar4.jpg')?>" alt="">
					{/eq}
				{/select}
...
<p class="h5 font-w300 text-right"> To see the day status use what's happening widget</p>
</div>
