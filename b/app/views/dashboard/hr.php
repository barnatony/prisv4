                    ...
                    <tbody>
                        <tr>
                            <td style="width: 50%;" class="  bg-info text-white border-r">
                                ...
                                <div class="h6 text-muted push-5-t text-white">Appraisal Due</div>
                            <div class="h1 font-w700">-</div>
                            </td>
...
<div style="color: #ff6c9d;margin-top: 14px !important;" class="h4 font-w600  text-center" >{total} </div>
</div>
