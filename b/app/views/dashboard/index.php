...
<section id="pro">
	          <div class="content bg-image" style="background-image: url('img/background/profile.jpg');">
                 <div class="push-50-t push-15 clearfix">
                    <div class="push-15-r pull-left animated fadeIn">
                       <img class="img-avatar img-avatar-thumb" src="<?php echo myUrl('employee_image')?>" alt="">
                    </div>
                <script type="text/x-template" id="emp-dashboard">
                   <div class="pull-left col-md-2 col-sm-12 col-xs-12 paper">
				    ...
				    {@eq value="Female"}
	                <img class="img-avatar img-avatar96" src="<?php echo str_replace('/b/',"/img/default-avatar_women.png" , myUrl('',true));?>" alt="Female">
				    {:else}
				    <img class="img-avatar img-avatar96" src="<?php echo str_replace('/b/',"/img/default-avatar_men.png" , myUrl('',true));?>" alt="Male">
					{/eq}
			        {/select}
				    {:else}
						<img class="img-avatar img-avatar96" src="<?php echo str_replace('/b/',"{employee_image}" , myUrl('',true));?>" alt="{employee_name}">
				    {/eq}
				    {/select}
	                </div>
	           </script>
                    <h1 class="h2 text-white push-5-t animated zoomIn"><?php echo $_SESSION['employee_name']?></h1>
                    <h2 class="h5 text-white-op animated zoomIn"><?php echo date('Y-m-d')?></h2>
                </div>
             </div>
                    <div class="content bg-white border-b" style="padding: 14px;">
                      <div class="sets row">
                        <div class="col-md-3 col-xs-6 col-sm-6 rect center">
                           <a href="<?php echo myUrl('mydashboard')?>" class="dash_board"><i class="si si-speedometer"></i><span class="sidebar-mini-hide">&nbsp; MyDashboard</span></a>
                        </div>
                            <div class="col-md-3 col-xs-6 col-sm-6 rect center">
                              <a href="<?php echo myUrl('attendance')?>" class="dash_board"><i class="fa fa-bar-chart"></i><span class="sidebar-mini-hide">&nbsp; Attendance</span></a>
                            </div>
                              <div class="col-md-3 col-xs-6 col-sm-6 rect center">
                               <a href="<?php echo myUrl('attendance/regularization')?>" class="dash_board"><i class="si si-graph"></i><span class="sidebar-mini-hide">&nbsp; Regularization</span></a>
                              </div>
                                <div class="col-md-3 col-xs-6 col-sm-6 rect center">
                                  <a href="<?php echo myUrl('leaveRequests')?>" class="dash_board"><i class="fa fa-pencil-square-o"></i><span class="sidebar-mini-hide">&nbsp; Leave Account</span></a>
                                </div>
                       </div>
                     </div>
</section>
						...
						<div class="col-lg-8">
							<div class="block block-themed">
                                <div class="block-header bg-primary">
                                    <ul class="box_size">
                                        <li class="active">
                                            <button type="button" class="action_set"><i class="fa fa-bullhorn"></i></button>
                                        </li>
                                        <li>
                                            <button type="button" class="action_set"><i class="si si-bell"></i></button>
                                        </li>
                                        <li>
                                            <button type="button" class="action_set"><i class="fa fa-sign-language"></i></button>
                                        </li>
                                         <li>
                                            <button type="button" class="action_set"><i class="si si-basket-loaded"></i></button>
                                        </li>
                                    </ul>
                                    <h3 class="block-title">FEEDS</h3>
                                </div>
                                <div class="block-content">
                                    <ul class="list list-timeline pull-t">
                                        ...
                                        <li>
                                            ...
                                            <div class="list-timeline-content row">
                                             <div class="col-md-9 ths">
                                             <p class="font-w600">+ 290 Page Likes</p>
                                             <p class="font-s13">This is great, keep it up!</p>
                                             </div>
                                             <div class="col-md-3 th">
                                             <div id="thumbs">
                                             <div class="col-md-6 col-xs-6 th th2">
                                             <i class="fa fa-mail-reply" aria-hidden="true"></i>
                                             <p class="thumb">Reply</p>
                                             </div>
                                             <div class="col-md-6 col-xs-6 th th2">
                                              <i class="si si-like " aria-hidden="true"></i>
                                             <p class="thumb">Likes</p>
                                             </div>
                                        ...
                                        <li>
                                            ...
                                            <div class="col-md-9 ths">
                                                ...
                                                <div class="col-md-3 th">
                                             <div id="thumbs">
                                             <div class="col-md-6 col-xs-6 th th1">
                                             <i class="fa fa-mail-reply " aria-hidden="true"></i>
                                             <p class="thumb">Reply</p>
                                             </div>
                                             <div class="col-md-6 col-xs-6 th th1">
                                                ...
                                                <ul class="nav-users push-10-t push">
                                                    <li>
                                                        <a href="base_pages_profile.html">
                                                            <img class="img-avatar" src="../img/default-avatar_men.png" alt="">
...
<div class="block-content block-content-full text-center">
                                    <button class="btn btn-sm btn-default"><i class="si si-user-follow "></i> ADD FEEDS</button>
                                    <button class="btn btn-sm btn-default"><i class="fa fa-fw fa-envelope text-info"></i> SEND MESSAGE</button>
                                </div>
</div>
<div class="block block-themed">
                                ...
                                <ul class="nav nav-tabs " data-toggle="tabs">
                                    <li class="active">
                                        <a href="#birthday"><i class="fa fa-birthday-cake" aria-hidden="true"></i>
                                        Birthday</a>
                                    </li>
                                    <li class="">
                                        <a href="#Anniversary"><i class="fa fa-flag-checkered" aria-hidden="true"></i>
                                        Anniversary</a>
                                    </li>
                                    <li class="">
                                        <a href="#holidays"><i class="fa fa-calendar" aria-hidden="true"></i>
                                        Holidays</a>
                                    </li>
                                    
                                </ul>
                                <div class="side-scroll">
                                <div class="day_content tab-content" id="side-overlay-scroll" style="max-height: 300px;min-height: 340px;padding: 10px;">
                                    ...
                                    <ul class="nav-users push">
                                        <li>
                                            <a href="base_pages_profile.html">
                                                <img class="img-avatar" src="../img/default-avatar_men.png" alt="">
                                                Keith Simpson 
                                                <div class="font-w400 text-muted"><small>Aug 28</small><i class="fa fa-envelope send_wish font-w600 text-info"></i></div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="base_pages_profile.html">
                                    ...
                                    <div class="tab-pane fade" id="Anniversary">
                                       <ul class="nav-users push">
                                        <li>
                                            <a href="base_pages_profile.html">
                                                <img class="img-avatar" src="../img/default-avatar_men.png" alt="">
                                    ...
                                    <div class="tab-pane fade" id="holidays">
                                        ...
                                        <p class="no_data text-muted">No Holidays for this Month</p>
                                    </div>
                                </div>
                            </div>       
                            </div>            
...
<div class="block">
                                <div class="block-header bg-gray-lighter">
                                    ...
                                    <h3 class="block-title"><i class="si si-users"></i> TEAM</h3>
                                </div>
                                <div class="team_show">
                                    <ul class="nav-users push">
                                        <li>
