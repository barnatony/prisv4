		...
		<div class="content  content-boxed col-md-12">
			<div class="push-20-t bg-white">
				<div class="block-header bg-gray-lighter">
					<span><b>Special Leave Requests</b></span>
					<ul class="block-options push-5 md-margin">
						<li>
							<div class="notification"></div>
							<a data-toggle="tooltip" title="" data-original-title="Request for a Leave" href="<?php echo myUrl("leaveRequests/splraise")?>"><i class="fa fa-plus btn btn-default plustwo"></i></a>
						</li>
					</ul>
				</div>
				<div class=" block-content table-responsive">
					...
					<div style="color: #3a87ad;background-color: #d9edf7;margin: 0px 0px 25px 0px;" class="alert alert-info alert-dismissable">
						...
						<p><i class="fa fa-caret-right"></i>You can't apply leave for previous month.</p>
						<p><i class="fa fa-caret-right"></i>Special Leaves needs to be granted first. <a href="<?php echo myUrl('leaveRequests/speciallr')?>">Click here</a> for granding request</p>
						<p><i class="fa fa-caret-right"></i>Special Leaves (CO, OD, WFH, ML, PT, BL, ML and OTR) can be availed after granting of the same.</p>
					</div>
