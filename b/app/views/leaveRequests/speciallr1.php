		...
		<div class="content  content-boxed col-md-12">
			<div class="push-20-t bg-white">
				<div class="block-header bg-gray-lighter">
					<span><b>Get Special Leave Credit</b></span>
					<ul class="block-options push-5 md-margin">
						<li>
							<div class="notification"></div>
							<a data-toggle="tooltip" title="" data-original-title="Request for grant" href="<?php echo myUrl("leaveRequests/grant")?>"><i class="fa fa-plus btn btn-default plustwo"></i></a>
						</li>
					</ul>
				</div>
