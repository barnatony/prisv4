				...
				<div class="block-header bg-gray-lighter">
					...
					<ul class="block-options push-5 md-margin">
						<li>
							...
							<a data-toggle="tooltip" title="" data-original-title="Request for a Leave" href="<?php echo myUrl("leaveRequests/raise")?>"><i class="fa fa-plus btn btn-default plustwo"></i></a>
						</li>
					</ul>
				</div>
